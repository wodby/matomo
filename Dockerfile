...
RUN set -ex; \
    ...
    curl -o /tmp/matomo.tar.gz -Lskj "http://builds.matomo.org/matomo-"${MATOMO_VER}".tar.gz"; \
    curl -o /tmp/matomo.tar.gz.asc -Lskj "http://builds.matomo.org/matomo-"${MATOMO_VER}".tar.gz.asc"; \
